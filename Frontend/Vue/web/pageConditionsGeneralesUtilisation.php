<div class="conditions">
	<article>
		...
		<p>
			Le présent document a pour objet de définir les modalités et conditions dans lesquelles d’une part, Deyleina, ci-après dénommé l’EDITEUR, met à la disposition de ses utilisateurs le site, et les services disponibles sur le site et d’autre part, la manière par laquelle l’utilisateur accède au site et utilise ses services.<br>
			Toute connexion au site est subordonnée au respect des présentes conditions.<br>
			Pour l’utilisateur, le simple accès au site de l’EDITEUR à l’adresse URL suivante <a>http://deyleina.fr/</a> implique l’acceptation de l’ensemble des conditions décrites ci-après.
		</p>
		<p>
			Les présentes conditions générales (CGU) sont une reproduction du Modèle de CGU (Conditions Générales d'Utilisation) d'un site Internet, dont le titulaire des droits d'auteur est DROITISSIMO.COM (<a>http://www.droitissimo.com/</a>), site internet d'information juridique grand public. retrouvez ce modèle ici : <a>http://www.droitissimo.com/contrat/conditions-generales-dutilisation-cgu-dun-site-internet</a>
		</p>

		<p class="texte-gras">Propriété intellectuelle : variante 1</p>

		<p>
			La structure générale du site <a>http://deyleina.fr/</a>, ainsi que les textes, graphiques, images, sons et  vidéos la composant, sont la propriété de l'éditeur ou de ses partenaires. Toute représentation et/ou reproduction et/ou exploitation partielle ou totale des contenus et services proposés par le site <a>http://deyleina.fr/</a>, par quelque procédé que ce soit, sans l'autorisation préalable et par écrit de Deyleina et/ou de ses partenaires est strictement interdite et serait susceptible de constituer une contrefaçon au sens des articles L 335-2 et suivants du Code de la propriété intellectuelle.<br>
		...
		<p class="texte-gras">Propriété intellectuelle : variante 2</p>
		...
		<p class="texte-gras">Propriété intellectuelle : variante 3</p>
		...
		<p class="texte-gras">Accès au site</p>
		...
		<p class="texte-gras">Modification des conditions d’utilisation</p>
		...
		<p class="texte-gras">Règles d'usage d'Internet</p>
		...
		<p>
			...
			L’utilisateur reconnaît que les données circulant sur Internet ne sont pas protégées notamment contre les détournements éventuels. La présence du logo [Deyleina] institue une présomption simple de validité. La communication de toute information jugée par l’utilisateur de nature sensible ou confidentielle se fait à ses risques et périls.<br>
		...
		<p class="texte-gras">Droit applicable</p>
		...
		<p>
			...
			Pour toute question relative aux présentes conditions d’utilisation du site, vous pouvez nous écrire à l’adresse suivante : deyleina.cosplay@gmail.com
		</p>
	</article>
</div>